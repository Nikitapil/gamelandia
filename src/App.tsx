    ...
    <div className="App">
      ...
      <main className="main">
        <Routes>
          ...
          <Route path="/battleship" element={<BattleShipRooms firestore={firestore} />} />
          <Route path="/battleship/:id" element={<BattleShip auth={auth} firestore={firestore} />} />
          {!user && <Route path='/registration' element={<SignUp auth={auth} />}/>}
