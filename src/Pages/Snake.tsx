...
export const Snake: FC<SnakeProps> = ({ auth }) => {
  ...
  return (
    <div className={`${snakeStyles.snake__container} container`} onKeyDown={onKeyPress} data-testid='snake-page'>
      ...
      <div className={snakeStyles.snake__btns}>
        ...
        {!gameOver && (
          <button className={snakeStyles.snake__btn} onClick={onStartGame} data-testid='start-game'>
            Start game
          </button>
        )}
      ...
      {!isNewGameButtonDisabled && (
        <div className={snakeStyles.snake__difficulty}>
          <p>Difficulty:</p>
          <button
            className={`${timer === 150 ? snakeStyles['snake-current-level'] : ""}`}
          ...
          <button
            className={`${timer === 100 ? snakeStyles['snake-current-level'] : ""}`}
          ...
          <button
            className={`${timer === 50 ? snakeStyles['snake-current-level'] : ""}`}
            onClick={() => setTimer(50)}
      ...
      <div className={snakeStyles.snake__boards}>
        ...
        <div className={snakeStyles.snake__controlls}>
          <button onClick={(e: any) =>onKeyPress(e, 'up') } className={snakeStyles['snake-controlls__btn']}><FontAwesomeIcon icon={faCircleChevronUp}/></button>
          <div className={snakeStyles['snake-controlls__sides']}>
            <button onClick={(e: any) =>onKeyPress(e, 'left') } className={snakeStyles['snake-controlls__btn']}><FontAwesomeIcon icon={faCircleChevronLeft}/></button>
            <button onClick={(e: any) =>onKeyPress(e, 'right') } className={snakeStyles['snake-controlls__btn']}><FontAwesomeIcon icon={faCircleChevronRight}/></button>
          </div>
          <button onClick={(e: any) =>onKeyPress(e, 'down') } className={snakeStyles['snake-controlls__btn']}><FontAwesomeIcon icon={faCircleChevronDown}/></button>
        </div>
